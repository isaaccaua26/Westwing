...
CREATE TABLE `bairro` (
  ...
  CONSTRAINT vinculo_bairro FOREIGN KEY (`fk_cliente`) REFERENCES `cliente`.`id_cliente`
...
CREATE TABLE `carro` (
  ...
  CONSTRAINT vinculo_carro FOREIGN KEY (`fk_cliente`) REFERENCES `cliente`.`id_cliente`
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `casa` (
  ...
  `fk_casa` int(11) NOT NULL,
  `fk_cliente` int(11) NOT NULL,
  `fk_bairro` int(11) NOT NULL,
  PRIMARY KEY (`id_casa`),
  CONSTRAINT vinculo_casa FOREIGN KEY (`fk_cliente`) REFERENCES `cliente`.`id_cliente`
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
